...
public class Book {
	...
	public Book(String bookId, String bookName, String bookAuthor, String bookType, BigDecimal bookPrice,
			String bookPress, Date bookPublicDate, Integer bookTotalNumber, Integer bookCurrentNumber,
			Date bookPurchaseDate, String bookSummary) {
		this.bookId = bookId;
